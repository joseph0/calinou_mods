...
function register_moreblocks_6d_alias(modname, origname, newname)
minetest.register_alias(modname .. ":slab_" .. origname .. "_inverted", "moreblocks:slab_" .. newname)
minetest.register_alias(modname .. ":slab_" .. origname .. "_wall", "moreblocks:slab_" .. newname)
minetest.register_alias(modname .. ":slab_" .. origname .. "_quarter_inverted", "moreblocks:slab_" .. newname .. "_quarter")
minetest.register_alias(modname .. ":slab_" .. origname .. "_quarter_wall", "moreblocks:slab_" .. newname .. "_quarter")
minetest.register_alias(modname .. ":slab_" .. origname .. "_three_quarter_inverted", "moreblocks:slab_" .. newname .. "_three_quarter")
minetest.register_alias(modname .. ":slab_" .. origname .. "_three_quarter_wall", "moreblocks:slab_" .. newname .. "_three_quarter")
minetest.register_alias(modname .. ":stair_" .. origname .. "_inverted", "moreblocks:stair_" .. newname)
minetest.register_alias(modname .. ":stair_" .. origname .. "_wall", "moreblocks:stair_" .. newname)
minetest.register_alias(modname .. ":stair_" .. origname .. "_wall_half", "moreblocks:stair_" .. newname .. "_half")
minetest.register_alias(modname .. ":stair_" .. origname .. "_wall_half_inverted", "moreblocks:stair_" .. newname .. "_half")
minetest.register_alias(modname .. ":stair_" .. origname .. "_half_inverted", "moreblocks:stair_" .. newname .. "_half")
minetest.register_alias(modname .. ":stair_" .. origname .. "_right_half_inverted", "moreblocks:stair_" .. newname .. "_right_half")
minetest.register_alias(modname .. ":stair_" .. origname .. "_wall_half", "moreblocks:stair_" .. newname .. "_half")
minetest.register_alias(modname .. ":stair_" .. origname .. "_wall_half_inverted", "moreblocks:stair_" .. newname .. "_half")
minetest.register_alias(modname .. ":stair_" .. origname .. "_inner_inverted", "moreblocks:stair_" .. newname .. "_inner")
minetest.register_alias(modname .. ":stair_" .. origname .. "_outer_inverted", "moreblocks:stair_" .. newname .. "_outer")
minetest.register_alias(modname .. ":panel_" .. origname .. "_top", "moreblocks:panel_" .. newname .. "_bottom")
minetest.register_alias(modname .. ":panel_" .. origname .. "_vertical", "moreblocks:panel_" .. newname .. "_bottom")
minetest.register_alias(modname .. ":micro_" .. origname .. "_bottom", "moreblocks:micro_" .. newname .. "_bottom")
minetest.register_alias(modname .. ":micro_" .. origname .. "_top", "moreblocks:micro_" .. newname .. "_bottom")
end

register_moreblocks_6d_alias("moreblocks", "stone", "stone")
register_moreblocks_6d_alias("moreblocks", "wood", "wood")
register_moreblocks_6d_alias("moreblocks", "cobble", "cobble")
register_moreblocks_6d_alias("moreblocks", "brick", "brick")
register_moreblocks_6d_alias("moreblocks", "sandstone", "sandstone")
register_moreblocks_6d_alias("moreblocks", "glass", "glass")
register_moreblocks_6d_alias("moreblocks", "tree", "tree")
register_moreblocks_6d_alias("moreblocks", "jungletree", "jungletree")
register_moreblocks_6d_alias("moreblocks", "desert_stone", "desert_stone")
register_moreblocks_6d_alias("moreblocks", "steelblock", "steelblock")
register_moreblocks_6d_alias("moreblocks", "mossycobble", "mossycobble")

register_moreblocks_6d_alias("moreblocks", "coalstone", "coal_stone")
register_moreblocks_6d_alias("moreblocks", "junglewood", "jungle_wood")
register_moreblocks_6d_alias("moreblocks", "circlestonebrick", "circle_stone_bricks")
register_moreblocks_6d_alias("moreblocks", "ironstone", "iron_stone")
register_moreblocks_6d_alias("moreblocks", "coalglass", "coal_glass")
register_moreblocks_6d_alias("moreblocks", "ironglass", "iron_glass")
register_moreblocks_6d_alias("moreblocks", "glowglass", "glow_glass")
register_moreblocks_6d_alias("moreblocks", "superglowglass", "super_glow_glass")
register_moreblocks_6d_alias("moreblocks", "coalchecker", "coal_checker")
register_moreblocks_6d_alias("moreblocks", "ironchecker", "iron_checker")
register_moreblocks_6d_alias("moreblocks", "cactuschecker", "cactus_checker")
register_moreblocks_6d_alias("moreblocks", "ironstonebrick", "iron_stone_bricks")
register_moreblocks_6d_alias("moreblocks", "stonesquare", "stone_tile")
register_moreblocks_6d_alias("moreblocks", "splitstonesquare", "split_stone_tile")
register_moreblocks_6d_alias("moreblocks", "woodtile", "wood_tile")
register_moreblocks_6d_alias("moreblocks", "woodtile_centered", "wood_tile_centered")
register_moreblocks_6d_alias("moreblocks", "woodtile_full", "wood_tile_full")
register_moreblocks_6d_alias("moreblocks", "obsidian", "obsidian")
register_moreblocks_6d_alias("moreblocks", "obsidian_glass", "obsidian_glass")
