...
for i=1,4,1 do
minetest.register_tool("moreblocks:screwdriver" .. i, {
	description = "Screwdriver in Mode " .. i,
	inventory_image = "moreblocks_screwdriver.png^tool_mode" .. i .. ".png",
	wield_image = "moreblocks_screwdriver.png",
...
mode_text={
{"Change rotation and do not change axis direction."},
{"Keep choosen face in front then rotate it."},
{"Change axis direction and reset rotation."},
...
if item["metadata"] == "" then
	minetest.chat_send_player(player_name, "Hold (sneak) and use to change screwdriwer modes.")
	mode = 0
...
item["name"] = "moreblocks:screwdriver" .. mode
